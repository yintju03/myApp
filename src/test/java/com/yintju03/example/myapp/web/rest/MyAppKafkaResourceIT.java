...
import com.yintju03.example.myapp.config.KafkaProperties;
...
class MyAppKafkaResourceIT {
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/my-app-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/my-app-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
